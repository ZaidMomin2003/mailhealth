...
export const metadata: Metadata = {
  ...
  authors: [{ name: "MailHealth", url: "https://mailhealth.online" }],
  creator: "MailHealth",
  publisher: "MailHealth",
  metadataBase: new URL("https://mailhealth.online"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                "@type": "SearchAction",
                target: "https://mailhealth.online/tools/{search_term_string}",
